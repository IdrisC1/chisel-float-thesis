...
module preprocess_mvp # (
  ...
  //  logic [C_MANT_FP64:0]         Mant_b_D;
   logic [EXP_BITS-1:0]        Exp_a_D;
   logic [EXP_BITS-1:0]        Exp_b_D;
   logic [MAN_BITS-1:0]       Mant_a_NonH_D;
   logic [MAN_BITS-1:0]       Mant_b_NonH_D;
  ...
  assign Sign_a_D = Operand_a_DI[WIDTH -1]; //1 bit for sign and -1 for index start a 0
  assign Sign_b_D = Operand_b_DI[WIDTH -1];
  assign Exp_a_D  = Operand_a_DI[WIDTH-2:MAN_BITS];
  assign Exp_b_D  = Operand_b_DI[WIDTH-2:MAN_BITS];
  assign Mant_a_NonH_D = Operand_a_DI[MAN_BITS-1:0];
  assign Mant_b_NonH_D = Operand_b_DI[MAN_BITS-1:0]; // No longer need to concatenate zeros
   ...
   assign Mant_a_D = {Hb_a_D,Mant_a_NonH_D}; //Add hidden bit
  ...
  //  assign Mant_b_prenorm_SNaN_S=(~Mant_b_NonH_D[C_MANT_FP64-1])&&((|Mant_b_NonH_D[C_MANT_FP64-2:0]));
   ...
   assign Mant_a_prenorm_QNaN_S=Mant_a_NonH_D[MAN_BITS-1]&&(~(|Mant_a_NonH_D[MAN_BITS-2:0]));
   assign Mant_a_prenorm_SNaN_S=(~Mant_a_NonH_D[MAN_BITS-1])&&((|Mant_a_NonH_D[MAN_BITS-2:0]));
   assign Mant_b_prenorm_QNaN_S=Mant_b_NonH_D[MAN_BITS-1]&&(~(|Mant_b_NonH_D[MAN_BITS-2:0]));
   assign Mant_b_prenorm_SNaN_S=(~Mant_b_NonH_D[MAN_BITS-1])&&((|Mant_b_NonH_D[MAN_BITS-2:0]));

  assign Mant_a_prenorm_zero_S=(Operand_a_DI[MAN_BITS-1:0] == '0);
  assign Mant_b_prenorm_zero_S=(Operand_b_DI[MAN_BITS-1:0] == '0);
  assign Exp_a_prenorm_Inf_NaN_S=(Operand_a_DI[WIDTH-2:MAN_BITS] == '1);
  assign Exp_b_prenorm_Inf_NaN_S=(Operand_b_DI[WIDTH-2:MAN_BITS] == '1);
  ...
  //   end
   ...
   always_comb
     begin
      ...
      //  else if(Sqrt_start_SI&&Ready_SI) // No longer sqrt
      //      Sign_z_DN = Sign_a_D;
       else
           Sign_z_DN = Sign_z_DP;
    end
  ...
  logic [MAN_BITS:0]            Mant_a_norm_DN,Mant_a_norm_DP;
  ...
  //  logic [C_MANT_FP64:0]            Mant_b_norm_DN,Mant_b_norm_DP;
   logic [MAN_BITS:0]            Mant_b_norm_DN,Mant_b_norm_DP;
