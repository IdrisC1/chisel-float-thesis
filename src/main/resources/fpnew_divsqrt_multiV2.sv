...
module fpnew_divsqrt_multiV2 #(
  ...
  (FpFormat == fpnew_pkg_snax::FP64)    ? 2'b01 :
  (FpFormat == fpnew_pkg_snax::FP16)    ? 2'b10 :
  (FpFormat == fpnew_pkg_snax::FP16ALT) ? 2'b11 :
                                    2'b10;  // default
  ...
  // Adjust result width and fix FP8 // Removed FP8 support for now
